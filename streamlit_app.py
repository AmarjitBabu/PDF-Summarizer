...
T5ForConditionalGeneration.from_pretrained('LaMini-Flan-T5-248M', force_download=True)
...
checkpoint = 'LaMini-Flan-T5-248M'  # Use just the string name of the model
...
def main():
    ...
    image = Image.open('PDFBOT.ai.jpg')
